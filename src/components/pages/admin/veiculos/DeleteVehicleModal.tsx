...
import { deleteVehicleAdminAction } from "@/actions/admin/vehicles/delete";
...
export function DeleteVehicleModal({ vehicleId, vehicleLabel }: DeleteVehicleModalProps) {
    ...
    const mutation = useMutation({
        mutationFn: () => deleteVehicleAdminAction(vehicleId),
        onSuccess: () => {
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 max-w-lg text-xs leading-relaxed text-j-gray-500 md:text-sm">
                            ...
                            <span className="font-bold text-j-blue-800">{vehicleLabel}</span>?
