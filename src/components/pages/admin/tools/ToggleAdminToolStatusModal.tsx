...
import { activateAdminToolAction } from "@/actions/admin/tools/activate";
import { deactivateAdminToolAction } from "@/actions/admin/tools/deactivate";

interface ToggleAdminToolStatusModalProps {
    toolId: number;
    toolName: string;
    nextStatus: "ACTIVATE" | "DEACTIVATE";
}

export function ToggleAdminToolStatusModal({ toolId, toolName, nextStatus }: ToggleAdminToolStatusModalProps) {
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 max-w-lg text-xs leading-relaxed text-j-gray-500 md:text-sm">
                            ...
                            <span className="font-bold text-j-blue-800">{toolName}</span>? Essa ação é administrativa e afeta o sócio dono da ferramenta.
                        </p>
                    </div>
                </div>
            </header>
...
export default ToggleAdminToolStatusModal;