...
import { deleteAdminToolAction } from "@/actions/admin/tools/delete";

interface DeleteAdminToolModalProps {
    toolId: number;
    toolLabel: string;
}

export function DeleteAdminToolModal({ toolId, toolLabel }: DeleteAdminToolModalProps) {
        ...
        >
            ...
            <header className="border-b border-j-gray-200 px-5 pb-5 pr-16 pt-6 md:px-8 md:pb-6 md:pr-20 md:pt-8">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-extrabold text-j-blue-800 md:text-2xl">Excluir ferramenta?</h2>
                        <p className="mt-1 max-w-lg text-xs leading-relaxed text-j-gray-500 md:text-sm">
                            ...
                            Essa ação é administrativa, não pode ser desfeita, e afeta o sócio dono da ferramenta.
                        </p>
                    </div>
                </div>
            </header>
...
export default DeleteAdminToolModal;