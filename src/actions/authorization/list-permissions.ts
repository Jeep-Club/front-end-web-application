...
export async function listPermissionsAction(): Promise<PermissionResponse[]> {
    try {
        ...
        throw new Error(extractApiErrorMessage(error, 'Erro ao listar permissões'), { cause: error });
    }
}
